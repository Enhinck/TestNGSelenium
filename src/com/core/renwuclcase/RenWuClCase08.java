...
public class RenWuClCase08 {
	/**
	 * 测试用例：
	 * 8、镇街职能办发起任务，需要片区审核，不直派网格，点击提交；镇街中心处理分派片区，片区长处理分派网格，网格长处理，片区长审核，镇街职能办审核结案。
	 */
	...
	public void zjznbRenWuJiaoBantj() {
		...
		jiaobantask.zjznbtijiaoTask3(tasktitle, taskmiaoshu, shangchuanfujian);
		// 点击退出按钮，即退出页面。
	...
	public void zjzxChuLi() {
		...
		dealtask.zjzxChuLi3();// 镇街中心进行处理并分派片区
		// 点击退出按钮，即退出页面。
