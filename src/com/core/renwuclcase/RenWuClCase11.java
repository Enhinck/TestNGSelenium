...
public class RenWuClCase11 {
	/**
	 * 测试用例：
	 * 11、镇街中心发起任务，需要片区审核，不直派网格，点击提交；片区长处理，网格长处理，片区长审核，镇街中心审核结案。
	 * 
	 */
	...
	public void beforeTest() {
		...
		tasktitle = "zjzx任务标题自动化" + CommonRandUtil.getDate() + "-" + CommonRandUtil.getRam();
		taskmiaoshu = "zjzx任务描述自动化" + CommonRandUtil.getDate() + "-" + CommonRandUtil.getRam();
	...
	public void zjzxRenWuJiaoBantj() {
		...
		jiaobantask.zjzxtijiaoTask3(tasktitle, taskmiaoshu, shangchuanfujian);
		// 点击退出按钮，即退出页面。
	...
	public void pqzChuLi() {
		...
		dealtask.pqzChuLi();// 片区长进行处理并分派网格
		// 点击退出按钮，即退出页面。
