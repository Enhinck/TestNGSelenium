...
public class RenWuClCase12 {
	/**
	 * 测试用例：
	 * 12、片区长发起任务，点击提交；网格长处理，片区长审核结案。
	 * 
	 */
	...
	public void pqzRenWuJiaoBantj() {
		...
		jiaobantask.pqztijiaoTask(tasktitle, taskmiaoshu, shangchuanfujian);
		// 点击退出按钮，即退出页面。
